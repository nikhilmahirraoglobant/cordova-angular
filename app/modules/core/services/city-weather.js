...
angular
    ...
    this.getWeatherInfo = function(myCity, successCB)
    {
        ...
        var params_obj = typeof myCity === 'string' ? {units:this.units,q:myCity, cnt:this.days, appid:this.appid} : {units:this.units, lat:myCity.lat, lon:myCity.lon, cnt:this.days, appid:this.appid};

        this.weatherAPI.get(params_obj)
